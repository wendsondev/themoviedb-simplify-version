...
export function Details() {
  ...
  const postImage = data.poster_path
    ? import.meta.env.VITE_API_IMAGE_BASE_URL + data.poster_path
    : '';
  const releaseCertification = data.release_dates.results
    .find((releases) => releases.iso_3166_1 === 'US')
    ?.release_dates.find(
      (releases) => releases.iso_639_1 === 'en' && releases.certification
    );
          ...
          <div className="md:mt-auto md:max-w-[60%]">
            <div>
              ...
              <div className="flex flex-col text-white text-lg">
                ...
                <span>{`${Math.floor(data.runtime / 60)}h ${Math.ceil(
                  data.runtime % 60
                )}m`}</span>
              </div>
            </div>
            ...
            <div className="flex items-center gap-3 my-6">
              <svg
                width="60"
                viewBox="0 0 55 55"
                className="-rotate-90 bg-white/10 rounded-full"
              >
                <circle
              ...
              <span className="w-28 text-white">User Score</span>
            </div>
        ...
        <div className="flex flex-col gap-6 md:w-[90%] md:mx-auto lg:w-[80%] md:min-h-[50vh]">
          ...
          <section className="flex flex-col gap-4 px-4">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              data.recommendations.results.length > 8 ? (
